...
export default function LoginPage() {
  ...
  const { login, googleLogin, getDashboardRoute } = useAuth();
          ...
          {success ? (
            ...
            <form onSubmit={submit} noValidate>
              ...
              <div style={{ textAlign: isRTL ? 'left' : 'right', marginBottom: 22 }}>
                <Link to="/forgot-password" style={{ fontSize: 13, color: '#0bceaa', textDecoration: 'none' }}>{t('auth.forgotPassword')}</Link>
              </div>
