...
namespace Medixa_AI.Api.Controllers.Api
{
    ...
    public class DoctorAuthController : ControllerBase
    {
        ...
        public DoctorAuthController(IDoctorAuthService doctorAuthService, IGoogleAuthService googleAuthService)
        {
        ...
        public async Task<ActionResult<AuthResponseDto>> GoogleLogin(GoogleAuthRequestDto dto)
        {
            ...
            var result = await _googleAuthService.AuthenticateDoctorAsync(dto);
            if (result == null)
